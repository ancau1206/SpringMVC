...
<body>
    ...
    <div id="main-wrapper" data-sidebartype="full">
        ...
        <div class="page-wrapper">
            ...
            <h4 class="card-title"><s:message code="home.departs.title.add" /></h4>
            <form:form action="departs/add" method="POST" modelAttribute="departs">
	                        ...
	                        <div class="card" data-select2-id="15">
	                            ...
	                            <!-- Mã phòng ban -->
									<div class="form-group row">
	                                    ...
	                                    <div class="col-md-9">
	                                        <form:input path="codeId" type="text" class="form-control" value="${newCodeId}" readonly="true"/>
